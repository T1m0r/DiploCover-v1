            ...
            <div class="row">
                <div class="col-sm-3 container-fluid">
                    <div id="Schatten"class="panel-body">
                        <img id="Bild" title="Diplocover" src="{{asset('images/Logo.jpeg')}}" alt="Logo" style="width:100%"><br/>
                        <img id="Bild" title="HTL Bildung mit Zukunft" src="{{asset('images/htltirol.png')}}" alt="HTL Tirol" style="width:100%"><br/>
                        <img id="Bild" title="Profile" src="{{asset(Auth::user()->stprof->profpic)}}" alt="Avatar" style="width:50%"><br/>
                        <div class="center"><h2>{{Auth::user()->firstname}} {{Auth::user()->lastname}}</h2></div><br/>
                        <button title="@lang('tags.student_app_menu_home_title')" onclick="location.href ='{{route('sthome')}}';" style="width:100%" type="button" class="Layoutbuttons btn-st-home btn btn-default btn-lg btn-block">@lang('profiles.student_app_menu_home')</button>
                        <button title="@lang('tags.student_app_menu_settings_title')" onclick="location.href ='{{route('student.edit')}}';" style="width:100%" type="button" class="Layoutbuttons btn-st-set btn btn-default btn-lg btn-block">@lang('profiles.student_app_menu_settings')</button>
                       <!--change lingk--> <button title="@lang('tags.student_app_menu_mprofile_title')" style="width:100%" onclick="location.href ='{{url('/student/'.Auth::user()->sID.'/profile')}}';" type="button" class="Layoutbuttons  btn-st-prof btn btn-default btn-lg btn-block">@lang('profiles.student_app_menu_mprofile')</button>
                        <button title="@lang('tags.student_app_menu_tm_title')" style="width:100%"  onclick="location.href ='{{route('student.team')}}';"type="button" class="Layoutbuttons btn-st-tm btn btn-default btn-lg btn-block">@lang('profiles.student_app_menu_tm')</button><br/>
                        <button title="@lang('tags.student_app_menu_logout_title')" style="width:50%" onclick="location.href ='{{route('logout')}}';" type="button" class=" Logout-Button btn btn-default btn-lg btn-block">@lang('profiles.student_app_menu_logout')</button>
                    </div>
                </div>
                @yield('content')
