                    ...
                    <table id="Klasse"style="width:100%">
                        ...
                        @foreach($tms as $tmm)
                            <tr>
                                ...
                                <td><button style="width:100%" onclick="location.href='/student/student/{{$tmm->sID}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                    ...
                    @if(isset($teach))
                        @if($teach != null)
                            ...
                            <table id="Klasse"style="width:100%">
                                ...
                                <td><button style="width:100%" onclick="location.href='/student/teacher/{{$teach->teachID}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                                        <i class="fa fa-user" style="color:black"></i></button></td>
                                </tbody>
                            </table>
                        @endif
