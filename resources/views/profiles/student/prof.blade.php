@extends('layouts.app')
@section('pgtitle',__('tags.pg_title_myprofile'))
@section('head')
        ...
        <div id="Schatten"class="panel-group">
            ...
            <div class="panel-body">
                <div class="ContactInfo">
                    ...
                    @else
                        <p>@lang('profiles.student_profile_cont_team') <a href="/team/{{urlencode($team->teamID)}}/profile">{{$team->tname}}</a></p>
                    @endif
            ...
            <div class="panel-body">
                <div class="ContactInfo">
                    @if(($st_prf->lebpath == "" or $st_prf->lebpath == null) and($st_prf->zeugpath == "" or $st_prf->zeugpath == null)
                        ...
                        <p>@lang('profiles.student_profile_nodocs')</p>
                    @else
