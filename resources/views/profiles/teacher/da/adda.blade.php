            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{csrf_field()}}
                        {!! Form::open(array('action' => 'Profile\DA\TeacherDAController@adda', 'method'=>'post')) !!}
                        <p>Required fields *</p>
                        @if ($errors->any())
                            <div class="alert alert-danger">
                                <ul>
                        ...
                        {{---<div class="form-group">
                            ...
                            {!! Form::select('emp', $tchs,['class'=>'form-control', 'required']) !!}

                        </div>---}}
                        {!! Form::label('empz', __('profiles.teach_da_dashboard_coteach')) !!}
                        {!! Form::select('empz', $tchs, ['class'=>'form-control']) !!}
                        <div class="form-group">
