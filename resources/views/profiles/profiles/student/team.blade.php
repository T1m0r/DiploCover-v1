                    ...
                    <table id="Klasse"style="width:100%">
                        ...
                        @foreach($tms as $tmm)
                            <tr>
                                ...
                                <td><button style="width:100%" onclick="location.href='/student/student/{{urlencode($tmm->sID)}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                        ...
                        @if($teach != null)
                            ...
                            <table id="Klasse"style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <td><button style="width:100%" onclick="location.href='/student/teacher/{{urlencode($teach->teachID)}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                                            <i class="fa fa-user" style="color:black"></i></button></td>
                                </tbody>
                            </table>
                        @endif
