...
@section('content')
    <div class="col-sm-7 container-fluid"><br/>
        ...
        @if(count($tm->Da()->get()) != 0)
            <div class="center error"><h3>@lang('profiles.employee_team_profile_da_da')</h3></div><br/>
        @else
            <div class="center success"><h3>@lang('profiles.employee_team_profile_da_noda')</h3></div><br/>
                    ...
                    <table id="Klasse"style="width:100%">
                        ...
                        @foreach($tms as $tmm)
                            <tr>
                                ...
                                <td><button style="width:100%" onclick="location.href='/employee/student/{{urlencode($tmm->sID)}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                        ...
                        @if($teach != null)
                            ...
                            <table id="Klasse"style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <td><button style="width:100%" onclick="location.href='/employee/teacher/{{urlencode($teach->teachID)}}/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                                            <i class="fa fa-user" style="color:black"></i></button></td>
                                </tbody>
                            </table>
                        @endif
