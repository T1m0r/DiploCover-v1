        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{csrf_field()}}
                        {!! Form::open(array('action' => 'Register\SchoolRegisterController@register', 'method'=>'post')) !!}
                        {{Form::token()}}
                        {{Form::token()}}
                        ...
                        <div class="form-group">
                            {!! Form::label('schname', 'Schoolname:') !!}
                            {!! Form::text('schname',null,['placeholder'=>'HTLX', 'class'=>'form-control']) !!}
                        </div>
