        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{csrf_field()}}
                        {!! Form::open(array('action' => 'Register\CompanyRegisterController@register', 'method'=>'post')) !!}
                        {{Form::token()}}
                        {{Form::token()}}
                        ...
                        <div class="form-group">
                            {!! Form::label('cname', 'Companyname:') !!}
                            {!! Form::text('cname',null,['placeholder'=>'Weihnachtsmann & Co KG','required', 'class'=>'form-control']) !!}
                        </div>
