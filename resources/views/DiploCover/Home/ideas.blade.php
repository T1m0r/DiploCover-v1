...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img class="img-responsive" src="{{asset('images/home/1920x1080/02.jpg')}}" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
                        <h2 class="carousel-title"><br>Einfache Erstellung von Profilen</h2>
                        <p style="color:#9037ab; font-size:30px;">Bereits nach nicht mal fünf Minuten können Sie loslegen <br/> Außerdem können wir bei Bedarf ihren Account einrichten</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="item">
            <img class="img-responsive" src="{{asset('images/home/1920x1080/04.jpg')}}" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
