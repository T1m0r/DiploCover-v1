    ...
    <div id="carousel-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="img-responsive" src="{{asset('images/home/1920x1080/0b1.jpg')}}" alt="Slider Image">
                <div class="container">
            ...
            <div class="item">
                <img class="img-responsive" src="{{asset('images/home/1920x1080/022.jpg')}}" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
            ...
            <div class="item">
                <img class="img-responsive" src="{{asset('images/home/1920x1080/l03.jpg')}}" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
            ...
            <div class="item">
                <img class="img-responsive" src="{{asset('images/home/1920x1080/004.jpg')}}" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
                ...
                <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                    <div data-height="height">
                        ...
                        <div class="service-info">
                            ...
                            <a href="https://www.qualityaustria.com"><img class="col-md-6" src="{{asset('/images/home/QA3.jpeg')}}"></a>
                            <a href="https://www.qualityaustria.com"><img class="col-md-6" src="{{asset('/images/home/QA1.jpeg')}}"></a>
                            <a href="https://www.qualityaustria.com"><img class="col-md-6" style="margin-top: 1.8em;" src="{{asset('/images/home/QA2.jpeg')}}"></a>
...
<!-- End DiploCover-Team-Zit -->
    ...
    <div class="promo-section overflow-h">
        ...
        <div class="promo-section-img-right">
            <img class="img-responsive hvr-grow-rotate" src="{{asset('/images/home/HTL_Jenbach.jpg')}}" alt="Content Image">
        </div>
    </div>
