...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        <li><a href='{{ backpack_url('school') }}'><i class='fa fa-tag'></i> <span>Schools</span></a></li>
        <li><a href='{{ backpack_url('teacher') }}'><i class='fa fa-tag'></i> <span>Teachers</span></a></li>
        <li><a href='{{ backpack_url('student') }}'><i class='fa fa-tag'></i> <span>Students</span></a></li>
        <li><a href='{{ backpack_url('company') }}'><i class='fa fa-tag'></i> <span>Companies</span></a></li>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href='{{ backpack_url('da') }}'><i class='fa fa-tag'></i> <span>DAs</span></a></li>
        <li><a href='{{ backpack_url('grade') }}'><i class='fa fa-tag'></i> <span>Grades</span></a></li>
        <li><a href='{{ backpack_url('idea') }}'><i class='fa fa-tag'></i> <span>Ideas</span></a></li>
        <li><a href='{{ backpack_url('intresst') }}'><i class='fa fa-tag'></i> <span>Intressts</span></a></li>
