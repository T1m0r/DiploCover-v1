<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><?php echo e(__('Create new Company')); ?></div>

                    <div class="card-body">
                        <?php echo e(csrf_field()); ?>

                        <?php echo Form::open(array('action' => 'Register\CompanyRegisterController@register', 'method'=>'post')); ?>
                        ...
                        <div class="form-group">
                            <?php echo Form::label('cname', 'Companyname:'); ?>

                            <?php echo Form::text('cname',null,['placeholder'=>'Weihnachtsmann & Co KG','required', 'class'=>'form-control']); ?>
