                    ...
                    <table id="Klasse"style="width:100%">
                        ...
                        <?php $__currentLoopData = $tms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><button style="width:100%" onclick="location.href='/student/student/<?php echo e(urlencode($tmm->sID)); ?>/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                        ...
                        <?php if($teach != null): ?>
                            ...
                            <table id="Klasse"style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <td><button style="width:100%" onclick="location.href='/student/teacher/<?php echo e(urlencode($teach->teachID)); ?>/profile';" title="Profilepage" type="button" class="Profilebutton btn btn-default btn-lg btn-block">
                                            <i class="fa fa-user" style="color:black"></i></button></td>
                                </tbody>
                            </table>
                        <?php endif; ?>
