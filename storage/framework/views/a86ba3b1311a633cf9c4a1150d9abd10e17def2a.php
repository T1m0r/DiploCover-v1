...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-7 container-fluid"><br/>
        <div id="Schatten"class="panel-group">
            <div class="panel-heading"><h4><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_head_owner'); ?></h4></div>
            <div id="panelbody"class="panel-body">
                <?php if(count($tchdashe) < 1 and count($tchdasz) < 1): ?>
                    <p><?php echo app('translator')->getFromJson('profiles.company_da_dashboard_da_noda'); ?></p>
                <?php else: ?>
                    <?php $__currentLoopData = $tchdashe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
                    <?php if(count($tchdasz) >= 1): ?>
                        <?php $__currentLoopData = $tchdasz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-9">
                                        ...
                                        <div class="col-sm-3 col-3">
                                            <div class="row">
                                                <?php if(count($da->empteacher()->get())<1): ?>
                                                    <p><?php echo app('translator')->getFromJson('profiles.company_da_dashboard_da_empl_noempl'); ?></p>
                                                <?php else: ?>
                                                    <div  class="hallo"><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_empl'); ?> <?php echo e($da->empteacher()->get()[0]->name); ?></div><br />
                                                    <img id="Profilbild" class="rounded mx-auto" src="<?php echo e(asset($da->empteacher()->get()[0]->prfpic)); ?>" alt="Avatar" height="50"><br />
                                                <?php endif; ?>
                                            </div>
                                            <br />
                ...
                <button title="<?php echo app('translator')->getFromJson('tags.teacher_da_dashboard_new_da_btn_title'); ?>" onclick="location.href='<?php echo e(route('teacher.new.da')); ?>';" style="width:10%" type="button" class="Plus-Button btn btn-default btn-lg btn-block">
                    <i class='fas fa-plus' style=width:100%></i> </button>
            </div>
        </div>
        <div id="Schatten"class="panel-group">
            <div class="panel-heading"><h4><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_head_teach'); ?></h4></div>
            <div id="panelgroup"class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_panel_teams_heading'); ?></div>
                    <?php if(count($teams)>0): ?>
                        <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div id="panelbody"class="panel-body">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        Team: <?php echo e($team->tname); ?>  <?php if(count($team->members()->get())<1): ?>
                                            <?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_teams_memberfail'); ?>
                                        <?php elseif(count($team->members()->get())==1): ?>
                                            (<?php echo e($team->members()->get()[0]->name); ?> )
                                        <?php else: ?>
                                            <p>(</p><?php $__currentLoopData = $team->members()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo e($member->name); ?>,
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><p>)</p>
                                        <?php endif; ?>
                                        <form action="<?php echo e(route('teacher.team.rmv')); ?>" method="post" onclick="if(confirm(' <?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_delete_da_quest'); ?> ')){return true;}else{event.stopPropagation();event.preventDefault();};">
                                            <?php echo e(csrf_field()); ?>

                                            <input type="hidden" name="teamID" value="<?php echo e($team->teamID); ?>" />
                                            <button type="submit" title="<?php echo app('translator')->getFromJson('tags.teacher_da_dashboard_da_rmv_team_title'); ?>" class="btn btn-success"  ><i class="glyphicon glyphicon-trash" ></i></button>
                                        </form>
                                    </div>
                                    <div class="panel-body">
                                        <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_team_tsize'); ?> <?php echo e(count($team->members()->get())); ?>  <?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_team_tsizestud'); ?></div>
                                        <?php if(count($team->DA()->get()) >0): ?>
                                            <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_team_dacomp'); ?><?php echo e($team->DA()->get()[0]->company()->get()[0]->compname); ?></div>
                                            <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_team_daempl'); ?> <?php echo e($team->DA()->get()[0]->employee()->get()[0]->name); ?></div>
                                            <div>DA-status: <?php echo e($team->DA()->get()[0]->status); ?></div>
                                        <?php else: ?>
                                            <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_team_noda'); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_teach_noda'); ?></p>
                                <p><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_teach_noda_tjoin'); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_panel_da_heading'); ?></div>
                <?php if(count($das)>0): ?>
                        ...
                        <div id="panelbody"class="panel-body">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    ...
                                    <form action="<?php echo e(route('teacher.da.rmv')); ?>" method="post" onclick="if(confirm(' <?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_delete_teach_team_quest'); ?> ')){return true;}else{event.stopPropagation();event.preventDefault();};">
                                        <?php echo e(csrf_field()); ?>

                                        <input type="hidden" name="DaID" value="<?php echo e($da->DAid); ?>" />
                                        <button type="submit" title="<?php echo app('translator')->getFromJson('tags.teacher_da_dashboard_da_rmv_da_title'); ?>" class="btn btn-success"  ><i class="glyphicon glyphicon-trash" ></i></button>
                                    </form>
                                </div>
                                <div class="panel-body">
                                    <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_tsize'); ?> <?php echo e(count($da->Team()->get()[0]->members()->get())); ?>  <?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_tsizestud'); ?></div>
                                    <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_dacomp'); ?> <?php echo e($da->company()->get()[0]->compname); ?></div>
                                    <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_empl'); ?> <?php echo e($da->employee()->get()[0]->name); ?></div>
                                    <div><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_status'); ?> <?php echo e($da->status); ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <div class="panel-body">
                        <p><?php echo app('translator')->getFromJson('profiles.teacher_da_dashboard_da_noda'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
