                ...
                <?php $__currentLoopData = $appls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div><?php echo app('translator')->getFromJson('profiles.company_applist_panel_school'); ?> <a style="color: whitesmoke" href="/employee/school/<?php echo e(urlencode($apply->Student()->first()->school()->first()->schoolID)); ?>/profile"><?php echo e($apply->Student()->first()->school()->first()->schoolname); ?></a></div>
                            ...
                            <div><?php echo app('translator')->getFromJson('profiles.company_applist_panel_team'); ?> <a style="color: whitesmoke" href="/employee/team/<?php echo e(urlencode($apply->Student()->first()->team()->first()->teamID)); ?>/profile"><?php echo e($apply->Student()->first()->team()->first()->tname); ?></a></div>
                        </div>
                        <div class="panel-body">
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $apply->Team()->first()->members()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-sm-2">
                                        <div  class="hallo"><a href="/employee/student/<?php echo e(urlencode($member->sID)); ?>/profile"><?php echo e($member->name); ?></a></div><br />
