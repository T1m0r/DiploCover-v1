...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-7 container-fluid"><br/>
        ...
        <?php if($da == null): ?>
            <h4><?php echo app('translator')->getFromJson('profiles.student_profile_cont_da_noda'); ?></h4>
        <?php else: ?>
        ...
        <div id="Schatten"class="panel-group">
            ...
            <div class="panel-body">
                <div class="ContactInfo">
                    ...
                    <?php else: ?>
                        <p><?php echo app('translator')->getFromJson('profiles.student_profile_cont_team'); ?> <a href="/team/<?php echo e(urlencode($team->teamID)); ?>/profile"><?php echo e($team->tname); ?></a></p>
                    <?php endif; ?>
            ...
            <div class="panel-body">
                <div class="ContactInfo">
                    <?php if(($st_prf->lebpath == "" or $st_prf->lebpath == null) and($st_prf->zeugpath == "" or $st_prf->zeugpath == null)
                        ...
                        <p><?php echo app('translator')->getFromJson('profiles.student_profile_nodocs'); ?></p>
                    <?php else: ?>
