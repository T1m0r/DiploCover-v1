...
<head>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-K9JPWC9');
    </script>
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K9JPWC9"
            ...
            <div class="menu-container">
                ...
                <div class="logo">
                    <a class="logo-wrap" href="index.php">
                        <img class="logo-img logo-img-main hvr-buzz-out" src="img/test.png" alt="DiploCover">
                        <img class="logo-img logo-img-active hvr-buzz-out" src="img/compalo.png" alt="DiploCover L">
                    </a>
                </div>
            <!-- End Logo -->
            </div>
            ...
            <div class="collapse navbar-collapse nav-collapse">
                <div class="menu-container">
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active hvr-underline-from-center" href='.$home.'>'.$hn.'</a></li>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="img-responsive" src="img/1920x1080/0b1.jpg" alt="Slider Image">
            <div class="container">
        ...
        <div class="item">
            <img class="img-responsive" src="img/1920x1080/l03.jpg" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
