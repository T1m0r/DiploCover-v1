...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img class="img-responsive" src="<?php echo e(asset('images/home/1920x1080/02.jpg')); ?>" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
        ...
        <div class="item">
            <img class="img-responsive" src="<?php echo e(asset('images/home/1920x1080/04.jpg')); ?>" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
