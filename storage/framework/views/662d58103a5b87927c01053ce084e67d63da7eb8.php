...
<html>
<head>
    <title>DiploCover | 404 Seite nicht vorhanden</title>
...
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>LOST IN <span>SPACE</span> DiploCover? Hmm, ich glaube diese Seite exisitiert leider nicht in diesem Universum.[vieleicht hast du ein falsches erwischt, versuch doch in einem der anderen Universen]</h3>
    ...
    <a href="<?php echo e(url('/')); ?>"><button class="denied__link">Go Home</button></a>
</div>
<script src="<?php echo e(asset('js/404.js')); ?>" type="text/javascript"></script>
</body>
</html>
