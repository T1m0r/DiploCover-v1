            ...
            <div class="collapse navbar-collapse nav-collapse">
                <div class="menu-container">
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item"><a class="nav-item-child nav-item-hover hvr-underline-from-center" href='/h/team'>Über uns</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active hvr-underline-from-center" href='/partner'>Partner</a></li>
...
<div class="parallax-window" data-parallax="scroll" data-image-src="<?php echo e(asset('images/home/1920x1080/l03.jpg')); ?>">
    <div class="parallax-content container">
        <h1 class="carousel-title">Partner</h1>
    </div>
</div>
<!--========== PARALLAX ==========-->
    ...
    <div class="row">
        <div class="col-sm-7 sm-margin-b-50">
            <div class="margin-b-30">
                <p style="font-size: 20px;">Wir sind immer auf der Suche nach Partner-Firmen die uns bei der weiteren Entwicklung von DiploCover unterstüzen.</p>
            </div>
        </div>
                ...
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <a href="http://www.spiegltec.at/" ><img class="img-responsive" src="<?php echo e(asset('/images/home/clients/logo_spiegltechgmbh.png')); ?>" alt="Partner Logo"></a>
                        </div>
                    </div>
