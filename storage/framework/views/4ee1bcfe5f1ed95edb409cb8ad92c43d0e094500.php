<?php $__env->startSection('pgtitle',__('tags.pg_title_da_edit')); ?>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(array('action' => 'Profile\DA\EmployeeDAController@settingsupdate', 'method'=>'POST')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Form::select('emp', $emps,$da->emplID, ['class'=>'form-control', 'required']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Form::select('empz', $emps,$da->emplIDz, ['class'=>'form-control']); ?>
