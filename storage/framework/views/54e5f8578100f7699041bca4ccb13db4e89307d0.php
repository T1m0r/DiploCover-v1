            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['method'=>'POST', 'action'=>'Register\StudentRegisterController@further','enctype'=>'multipart/form-data']); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <h3>Documents</h3>
                                    <?php echo Form::label('leb', 'Lebenslauf:'); ?>

                                    <?php echo Form::file('leb', null,['class'=>'form-control']); ?>

                                    <?php echo Form::label('zeug', 'Letztes Zeugniss:'); ?>

                                    <?php echo Form::file('zeug', null,['class'=>'form-control']); ?>

                                    <?php echo Form::label('oth', 'Andere Dokumente:'); ?>

                                    <?php echo Form::file('oth', null,['class'=>'form-control']); ?>

                                    <?php echo Form::label('oth1', 'Anderes Dokumente:'); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::password('pswd', ['class'=>'form-control', 'required','placeholder'=>'123456789']); ?>
