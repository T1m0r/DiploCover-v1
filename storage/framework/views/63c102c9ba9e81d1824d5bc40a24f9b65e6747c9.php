        ...
        <div id="Schatten"class="panel-group">
            ...
            <div class="panel-body">
                <div class="ContactInfo">
                    ...
                    <?php else: ?>
                        <p><?php echo app('translator')->getFromJson('profiles.student_profile_cont_team'); ?> <a href="/employee/team/<?php echo e(urlencode($team->teamID)); ?>/profile"><?php echo e($team->tname); ?></a></p>
                    <?php endif; ?>
