...
<!-- GLOBAL MANDATORY STYLES -->
    ...
    <link href="<?php echo e(asset('css/home/col.css')); ?>" rel="stylesheet" type="text/css"/>
...
<!--========== PARALLAX ==========-->
<div class="parallax-window" data-parallax="scroll" data-image-src="<?php echo e(asset('images/home/1920x1080/l03.jpg')); ?>">
...
<div class="content-lg container">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-sm-offset-1">
            <img class="img-responsive" src="<?php echo e(asset('images/home/640x380/01.jpg')); ?>" alt="...">
        </div>
    </div>
    <!--// end row -->
</div>
        ...
        <div class="row">
                ...
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo e(asset('/images/home/team/DSC_4582-Bearbeitet-uai-960x960.jpg')); ?>" alt="Team Image">
                        </div>
                    </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo e(asset('/images/home/team/DSC_4585-Bearbeitet-uai-960x960.jpg')); ?>" alt="Team Image">
                        </div>
                    </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo e(asset('/images/home/team/DSC_4584-Bearbeitet-uai-960x960.jpg')); ?>" alt="Team Image">
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo e(asset('/images/home/team/DSC_4586-Bearbeitet-uai-960x960.jpg')); ?>" alt="Team Image">
                        </div>
                    </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class=" hvr-grow">
                    <div class="bg-color-white margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo e(asset('/images/home/team/DSC_4587-Bearbeitet-uai-960x960.jpg')); ?>" alt="Team Image">
                        </div>
                    </div>
