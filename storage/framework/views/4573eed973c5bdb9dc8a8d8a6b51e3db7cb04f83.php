...
<?php $__env->startSection('content'); ?>
    ...
    <div id="DasTeam"class="row">
        <div class="container-fluid bg-3 text-center">
            <div id="Teamname"class="Team"><?php echo e($tm->tname); ?></div>
        </div>
        <div class="container-fluid bg-3 text-center">
            <div id="Bild1" class="col-sm-4 container">
                <img src="<?php echo e(asset($tms[0]->stprof->profpic)); ?>" alt="Avatar" class="img-circle">
                <div class="middle">
                    <div class="text"><?php echo e($tms[0]->name); ?></div>
                </div>
            </div>
            <?php if(isset($tms[1])): ?>
                <div id="Bild2" class="col-sm-4 container">
                    <img src="<?php echo e(asset($tms[1]->stprof->profpic)); ?>" alt="Avatar" class="img-circle" >
                    <div class="middle">
                        <div class="text"><?php echo e($tms[1]->name); ?></div>
                    </div>
                </div>
            <?php endif; ?>
            <?php if(isset($tms[2])): ?>
                <div id="Bild3" class="col-sm-4 container">
                    <img src="<?php echo e(asset($tms[2]->stprof->profpic)); ?>avatar.png" alt="Avatar" class="img-circle" >
                    <div class="middle">
                        <div class="text"><?php echo e($tms[2]->name); ?></div>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        <div class="container-fluid bg-3 text-center">
            <?php if(isset($tms[3])): ?>
                <div id="Bild3" class="col-sm-6 container">
                    <img src="<?php echo e(asset($tms[3]->stprof->profpic)); ?>" alt="Avatar" class="img-circle" >
                    <div class="middle">
                        <div class="text"><?php echo e($tms[3]->name); ?></div>
                    </div>
                </div>
            <?php endif; ?>
            <?php if(isset($tms[4])): ?>
                <div id="Bild3" class="col-sm-6 container">
                    <img src="<?php echo e(asset($tms[4]->stprof->profpic)); ?>" alt="Avatar" class="img-circle" >
                    <div class="middle">
                        <div class="text"><?php echo e($tms[4]->name); ?></div>
                    </div>
                </div>
            <?php endif; ?>
        </div>
